...
struct super_block {
	...
	unsigned int 	nr_sects;	  /**< How many sectors (including bit maps) */
 ...
 */
struct inode {
	unsigned int 	i_mode;		/**< Accsess mode. Unused currently */
	...
	unsigned char _unused[16];	/**< Stuff for alignment */
